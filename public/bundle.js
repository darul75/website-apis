...
var APP = React.createClass({displayName: "APP",  
  render: function() {
    var description =  'Le savoir-faire d\'Apis Lazuli Consulting : audit social, détection des potentiels, réflexion sur les organigrammes, coaching individuel, formation managériale, recrutement.';
    return (
      React.createElement("html", null, 
        React.createElement("head", null, 
          ...
          React.createElement("link", {rel: "icon", href: "public/images/favicon.ico"}), 
...
},{"./chapters-v1.json":2,"./components/index.js":4,"react":157}],2:[function(require,module,exports){
module.exports={
	"menus": [
		{
			"path": "#accueil",
	...
	"sections": [
		{
	    "immersive": {
	    	"img": "public/images/img-1600-1200_5.jpg",
	    	"w": "1600",
	    	"h": "1200",
	    	"ratio": "1"
	    },
		...
		{
	    "immersive": {
	    	"img": "public/images/img-1600-1200_3.jpg",
	    	"w": "1600",
	    	"h": "1200",
	    	"ratio": "1"
	    },
	    ...
	    "chapter": {
	    	...
	    	"paragraphsCol1": [
	    		...
	    		{
	    			"type": "expertise",
	    			"text": "Une sélection et un choix transparent de l’adéquation du potentiel de chacun aux besoins de l’entreprise (assesment cognitif)"
	    		}
	    	],
	    	"paragraphsCol2": [    		
	    		{
		...
		{
	    "immersive": {
	    	"img": "public/images/img-1600-1200_2.jpg",
	    	"w": "1600",
	    	"h": "1200",
	    	"ratio": "1"
	    },
		...
		{
	    "immersive": {
	    	"img": "public/images/img-1600-1200_1.jpg",
	    	"w": "1600",
	    	"h": "1200",
	    	"ratio": "1"
	    },
		...
		},
		{
	    	...
	    	"paragraphsCol1": [
	    		...
	    		{
	    			"type": "expertise",
	    			"text": "Assesment cognitif"
	    		},
	    		{
	    			"type": "expertise",
	    			"text": "Bilan professionnel"
	    		},
	    		{
	    			"type": "expertise",
		...
		{
	    "immersive": {
	    	"img": "public/images/img-1600-1200_4.jpg",
	    	"w": "1600",
	    	"h": "1200",
	    	"ratio": "1"
	    },
			...
			"chapter": {
		    	...
		    	"story": {
			    	...
			    	[
			    		...
			    		{
			    			"type": "html",
			    			"text": "<p class='footer'><b>Apis Lazuli</b>, clin d'oeil de Apis avec Apis-Lazuli: pierre sacrée égyptienne, structure le développement de la vision clairvoyante en la raccordant à la vie quotidienne.</p>"
			    		}
			    	]					
					},
					"styleHeight": 600
    ...
    return (
      React.createElement("div", {id: "footer"}, 	
        React.createElement("footer", null, 
          React.createElement("span", null, React.createElement("a", {href: "/mentions"}, "Mentions légales"))
        )
      )
    )
  }
  ...
  render: function() {
    if (this.props.data && this.props.data.sections) {
      ...
      var chaptersNodes = this.props.data.sections.map(function(section, index) {                         
        ...
        if (section.chapter) {  
          var homeCss = index === 0 ? '' : '';
          var logo = index === 0 ? React.createElement(Logo, null) : '';
          var story = section.chapter.story ? React.createElement(Story, {story: section.chapter.story}) : '';
          var parallaxStyle;
          var parallaxImage;          
          var lightButton = '';
          ...
          if (section.immersive) {            
            ...
            parallaxImage = React.createElement("div", {"data-fit": "500", style: parallaxStyle, className: ""})
            ...
            lightButton = React.createElement(LightButton, {onLightButtonOver: boundLightOver, onLightButtonOut: boundLightOut})
          } 
                ...
                React.createElement("div", {className: "layout"}, 
                  React.createElement("div", {className: "layout-content"}, 
                    React.createElement("div", {className: "chapter"}, 
                      React.createElement("div", {className: chapterClass}, 
  ...
  render: function() {    
    return (
      React.createElement("div", {id: "app"}, 
        React.createElement(Menu, {data: this.props.site}), 
        React.createElement(ChapterList, {data: this.props.site, size: this.props.height}), 
        React.createElement(Footer, null)
      )
    );
  }
...
},{"./footer":3,"./logo":5,"./menu":6,"./section-button":7,"./section-citation":8,"./section-paragraph":9,"./story":10,"react":157}],5:[function(require,module,exports){
'use strict'
...
var Logo = React.createClass({displayName: "Logo",
  render: function() {
    return (
      React.createElement("div", {className: "logo-white"}, 
        React.createElement("a", {href: "#accueil"}, 
          React.createElement("img", {src: "public/images/logo-blanc.svg", height: "200px", className: "logo-home animated bounce"})
        )
      )
    )
  }
  ...
  render: function() {    
      if (this.props.data && this.props.data.menus) {                  
        var menusNodes = this.props.data.menus.map(function(menu, index) {        
          ...
          return (
            React.createElement("li", {key: keyChap}, 
              React.createElement("a", {href: menu.path}, 
                menu.text
              )
            )          
          );
        ...
        return (
         React.createElement("div", {className: "header_menu"}, 
          React.createElement("header", {className: "menu-nav "}, 
            React.createElement("ul", {id: "menu-menu-principal", className: "menu"}, 
              React.createElement("li", null, 
                React.createElement("a", {href: "/"}, 
                  React.createElement("img", {src: "public/images/logo-blue.svg", height: "80"})
                )
              ), 
              menusNodes
            )
...
var LightButton = React.createClass({displayName: "LightButton",  
  ...
  render: function() {    
    return (
      React.createElement("div", {className: "fake-lamp", onMouseEnter: this.mouseOver, onMouseLeave: this.mouseOut}, 
        React.createElement("i", {className: "fa fa-lightbulb-o fa-3x fa-inverse animated bounce"})
      )
    );
  }
});
...
},{"react":157}],8:[function(require,module,exports){
'use strict'

var React = require('react');

var Citation = React.createClass({displayName: "Citation",
  render: function() {
    var citationMarkup = ""    
    if (this.props.citation) {
      ...
      citationMarkup =         
        React.createElement("div", {className: citationClassname}, 
          React.createElement("div", {className: "text"}, this.props.citation.text, 
            React.createElement("div", {className: "author"}, this.props.citation.author)
          )
        )                
    } else {
      citationMarkup = React.createElement("div", null)
    }   
      ...
      paragraphNodes = this.props.paragraphs.map(function(paragraph, index) {
        ...
        if (typeof paragraph === 'object') {
          switch (paragraph.type) {
            case 'vcard': 
            paragraphMarkup = React.createElement("div", {key: paragraphKey, id: paragraph.vcard.id, className: "vcard"}, 
              React.createElement("div", {className: "org"}, React.createElement("b", null, paragraph.vcard.org)), 
              React.createElement("a", {className: "email", href: paragraph.vcard.email}, "contact@apis-lazuli-consulting.fr"), 
              React.createElement("div", {className: "adr"}, 
              React.createElement("div", {className: "street-address"}, paragraph.vcard.address.street), 
              React.createElement("span", {className: "locality"}, paragraph.vcard.address.locality), ", ", React.createElement("span", {className: "postal-code"}, paragraph.vcard.address.postal)
             )
            )
            break;
            case 'vcard-person': 
            paragraphMarkup = React.createElement("div", {key: paragraphKey, id: paragraph.vcard.id, className: "vcard"}, 
              React.createElement("div", {className: "name"}, React.createElement("b", null, paragraph.vcard.name)), 
              React.createElement("div", {className: "title"}, paragraph.vcard.title), 
              React.createElement("div", {className: "tel"}, paragraph.vcard.phone)
            )
            break;
            case 'html':
              paragraphMarkup = React.createElement("div", {key: paragraphKey, dangerouslySetInnerHTML: {__html: paragraph.text}})
            break;
            case 'html-paragraph':
              paragraphMarkup = React.createElement("p", {key: paragraphKey, dangerouslySetInnerHTML: {__html: paragraph.text}})
            break;
            default:
              paragraphMarkup = React.createElement("div", {key: paragraphKey}, 
                React.createElement("div", {className: "rectangle color-2"}), 
                React.createElement("p", {className: paragraph.type}, paragraph.text)
              )
            break;
          }                            
        } else {
          paragraphMarkup = React.createElement("p", {style: paragraphStyle, key: paragraphKey, dangerouslySetInnerHTML: {__html: paragraph}})
        }
    ...
    return (
      React.createElement("div", null, 
        ...
        React.createElement("div", {className: "grid"}, 
	        React.createElement("div", {className: "grid__col grid__col--1-of-3", dangerouslySetInnerHTML: {__html: column1}}
	        ), 
	        React.createElement("div", {className: "grid__col grid__col--1-of-3", dangerouslySetInnerHTML: {__html: column2}}	            
	        ), 
	        React.createElement("div", {className: "grid__col grid__col--1-of-3", dangerouslySetInnerHTML: {__html: column3}}	            
	        )
	      )
      )
    )
...
},{"./ReactCurrentOwner":47,"./ReactElement":63,"./ReactPropTypeLocations":82,"./monitorCodeUse":147,"./warning":156,"_process":11}],65:[function(require,module,exports){
(function (process){
/**
 * Copyright 2014, Facebook, Inc.
 * All rights reserved.
