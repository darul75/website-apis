...
},{"./chapters-v1.json":2,"./components/index.js":3,"react":150}],2:[function(require,module,exports){
module.exports={
	"menus": [
		{
			"path": "#accueil",
	    	...
	    	"paragraphsCol2": [
	    		...
	    		},
	    		{
	    			...
	    			"vcard": {
	    				...
	    				"email": "mailto:contact@apis-lazuli-consulting.fr",
	    				"address": {
  ...
  render: function() {    
    return (
      React.createElement("div", {className: "fake-lamp", onMouseEnter: this.mouseOver, onMouseLeave: this.mouseOut}, 
        React.createElement("i", {className: "fa fa-lightbulb-o fa-2x fa-inverse animated bounce"})
      )
    );
  }
});
